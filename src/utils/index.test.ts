...
import { TokenAmount, Token, ChainId, Percent, JSBI } from '@kimchiswap/sdk'
...
describe('utils', () => {
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0xCa7bed857483f3EC3Fd7eA49d46A517a76f51025')).toBe('0xCa7bed857483f3EC3Fd7eA49d46A517a76f51025')
      expect(isAddress('0xCa7bed857483f3EC3Fd7eA49d46A517a76f51025')).toBe('0xCa7bed857483f3EC3Fd7eA49d46A517a76f51025')
    })
    ...
    it('fails if too long', () => {
      expect(isAddress('0xCa7bed857483f3EC3Fd7eA49d46A517a76f51025')).toBe(false)
    })
  })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0xCa7bed857483f3EC3Fd7eA49d46A517a76f51025')).toBe('0xCa7b...1025')
    })
