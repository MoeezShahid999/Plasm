import { ChainId, JSBI, Percent, Token, WETH } from '@kimchiswap/sdk'
import { AbstractConnector } from '@web3-react/abstract-connector'

import { fortmatic, injected, portis, walletconnect, walletlink } from '../connectors'

export const ROUTER_ADDRESS = '0x9aF79131DA1131805FA78aeca96f1fD63a1DfD05'
...
const KSWAP_ADDRESS = '0x7705c572d9cc824fBA4e4EFb40F00916534396d9'
export const KSWAP: { [chainId in ChainId]: Token } = {
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, KSWAP_ADDRESS, 18, 'KSWAP', 'Kimchiswap'),
