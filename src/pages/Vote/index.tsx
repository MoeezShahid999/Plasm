...
import { KSWAP, ZERO_ADDRESS } from '../../constants'
import { JSBI, TokenAmount, ChainId } from '@kimchiswap/sdk'
...
export default function Vote() {
  ...
  const showUnlockVoting = Boolean(
    kswapBalance && JSBI.notEqual(kswapBalance.raw, JSBI.BigInt(0)) && userDelegatee === ZERO_ADDRESS
  )
  ...
  return (
    <PageWrapper gap="lg" justify="center">
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Kswap Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  KSWAP tokens represent voting shares in Kswap governance. You can vote on each proposal yourself or
                  delegate your votes to a third party.
                </TYPE.white>
              </RowBetween>
              <ExternalLink
                style={{ color: 'white', textDecoration: 'underline' }}
                href="https://kimchiswap.io/blog/kswap"
                target="_blank"
              >
                <TYPE.white fontSize={14}>Read more about Kswap governance</TYPE.white>
              </ExternalLink>
            </AutoColumn>
          </CardSection>
          <CardBGImage />
      ...
      <TopSection gap="2px">
        <WrapSmall>
          ...
          {showUnlockVoting ? (
            ...
            JSBI.notEqual(JSBI.BigInt(0), kswapBalance?.raw) ? (
            <TYPE.body fontWeight={500} mr="6px">
              <FormattedCurrencyAmount currencyAmount={kswapBalance} /> Votes
            </TYPE.body>
          ) : (
            ''
          )}
      ...
      <TYPE.subHeader color="text3">
        A minimum threshhold of 1% of the total KSWAP supply is required to submit proposals
      </TYPE.subHeader>
    </PageWrapper>
  )
}
