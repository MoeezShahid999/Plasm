...
// const KSWAPAmount = styled(AccountElement)`
//   color: black;
//   padding: 4px 8px;
//   height: 36px;
//   border-radius: 10px;
...
// const KSWAPWrapper = styled.span`
//   width: fit-content;
//   position: relative;
//   cursor: pointer;
...
export default function Header() {
  ...
  // const aggregateBalance: TokenAmount | undefined = useAggregateKswapBalance()
  ...
  return (
    <HeaderFrame>
      ...
      <Modal isOpen={showKswapBalanceModal} onDismiss={() => setShowKswapBalanceModal(false)}>
        <KswapBalanceContent setShowKswapBalanceModal={setShowKswapBalanceModal} />
      </Modal>
      <HeaderRow>
        <Title href=".">
          <KswapIcon>
        ...
        <HeaderLinks>
          ...
          {/* <StyledNavLink id={`stake-nav-link`} to={'/Kswap'}>
            KSWAP
          </StyledNavLink> */}
          <StyledNavLink id={`stake-nav-link`} to={'/votepage'}>
            Vote
          </StyledNavLink>
          <StyledExternalLink id={`stake-nav-link`} href={'https://info.kimchiswap.io'}>
        ...
        <HeaderElement>
          ...
          {/* {!availableClaim && aggregateBalance && (
            <KSWAPWrapper onClick={() => setShowKswapBalanceModal(true)}>
              <KSWAPAmount active={!!account && !availableClaim} style={{ pointerEvents: 'auto' }}>
                {account && (
                  <HideSmall>
                    <TYPE.white
                      style={{
