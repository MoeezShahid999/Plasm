import { TokenAmount } from '@kimchiswap/sdk'
      ...
      {showClaimPopup && !showClaimModal && (
        <StyledClaimPopup gap="md">
          ...
          <AutoColumn style={{ padding: '2rem 0', zIndex: 10 }} justify="center">
            <KswapToken width="48px" src={tokenLogo} />{' '}
            <TYPE.white style={{ marginTop: '1rem' }} fontSize={36} fontWeight={600}>
              {unclaimedAmount?.toFixed(0, { groupSeparator: ',' } ?? '-')} KSWAP
            </TYPE.white>
